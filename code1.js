...
gdjs.GameCode.GDLeftArrowRoundButtonObjects4= [];
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = (runtimeScene.getScene().getVariables().getFromIndex(0).getAsNumber() == 1.25);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = (runtimeScene.getScene().getVariables().getFromIndex(0).getAsNumber() == 1.50);
}
if (isConditionTrue_0) {
gdjs.copyArray(gdjs.GameCode.GDScoreMultiplierObjects1, gdjs.GameCode.GDScoreMultiplierObjects2);
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = (runtimeScene.getScene().getVariables().getFromIndex(0).getAsNumber() == 1.75);
}
if (isConditionTrue_0) {
gdjs.copyArray(gdjs.GameCode.GDScoreMultiplierObjects1, gdjs.GameCode.GDScoreMultiplierObjects2);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11609492);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDBallObjects1 */
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11616644);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11616556);
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11613396);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11598964);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11604300);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Ball"), gdjs.GameCode.GDBallObjects1);
...
{runtimeScene.getGame().getVariables().getFromIndex(1).setNumber(Math.floor(runtimeScene.getGame().getVariables().getFromIndex(0).getAsNumber()));
    ...
    gdjs.GameCode.GDScoreLabelObjects1[i].getBehavior("Text").setText("Счет: " + runtimeScene.getGame().getVariables().getFromIndex(1).getAsString());
}
}{for(var i = 0, len = gdjs.GameCode.GDLivesObjects1.length ;i < len;++i) {
    gdjs.GameCode.GDLivesObjects1[i].getBehavior("Text").setText("Жизнь: " + ((gdjs.GameCode.GDBallObjects1.length === 0 ) ? gdjs.VariablesContainer.badVariablesContainer : gdjs.GameCode.GDBallObjects1[0].getVariables()).getFromIndex(2).getAsString());
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDLeftArrowRoundButtonObjects1.length;i<l;++i) {
    if ( gdjs.GameCode.GDLeftArrowRoundButtonObjects1[i].getBehavior("ButtonFSM").IsPressed((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDLeftArrowRoundButtonObjects1[k] = gdjs.GameCode.GDLeftArrowRoundButtonObjects1[i];
        ++k;
    }
}
gdjs.GameCode.GDLeftArrowRoundButtonObjects1.length = k;
if (isConditionTrue_0) {
...
gdjs.GameCode.GDLeftArrowRoundButtonObjects4.length = 0;
